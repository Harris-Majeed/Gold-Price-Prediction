...
By [<b>Haris Majeed</b>](https://hemakalyan.netlify.app)
...
[![Twitter](https://img.shields.io/twitter/follow/Haris Majeed?style=social)](https://twitter.com/Haris Majeed)
...
1. **Clone the Repository**
   ...
   - Run the following command to clone the GitHub repository:
     ```
     git clone https://github.com/Harris-Majeed/Gold-Commodity-Price-Prediction.git
     ```
...
2. **Run the Docker Container**
   - Start the Docker container by running the following command. Adjust the port mapping as needed:
     ```
     docker run -p 5000:5000 kalyan45/Goldapp
     ```
...
Haris Majeed - [harismajeed299@gmail.com](harismajeed299@gmail.com)<br>
